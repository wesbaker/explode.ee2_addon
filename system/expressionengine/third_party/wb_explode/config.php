...
if (! defined('EXPLODE_NAME'))
{
	...
	define('EXPLODE_DESC', 'Given a string, a value to look for, and optionally an offset, will take a string separated by a delimiter (e.g. |) and return the first or first value or the odd or even values.');
